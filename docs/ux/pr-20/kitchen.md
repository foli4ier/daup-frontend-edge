...
![Places, no house — desktop](places-empty-desktop.png)
...
![Places, no house — mobile 390](places-empty-mobile.png)

Same copy. **+ Register** is a full-width terracotta tap.

## wizard-create-place-desktop.png

![Create your company / place — desktop](wizard-create-place-desktop.png)
...
![Create your company / place — mobile 390](wizard-create-place-mobile.png)

390-wide. Street address and **Continue** may sit below the fold on 844-tall (parked from #18).

## places-two-desktop.png

![Places with The Olive and Salt — desktop](places-two-desktop.png)
...
![Places with The Olive and Salt — mobile 390](places-two-mobile.png)

Same doors stacked. **Open.** is a 48px terracotta tap.

## place-detail-desktop.png

![Salt place control plane — desktop](place-detail-desktop.png)
